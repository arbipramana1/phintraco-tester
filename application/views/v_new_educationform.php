  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Employee education form</li>
      </ol>
    </section><br>
        ...
        <div class="col-md-12" >
          <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Employee education form</h3>
              </div>
            <div class="box box-body">
              <div class="col-md-12">
                ...
                <form action="http://localhost/phintraco/c_employee/new_documentform" method="POST"> <!-- << showData ini contoh, nggak usah dipake gpp -->
                  <br>
                ...
                <template id="row-item">
                  <tr class="row-item">
                    ...
                    <td>
                      <select>
                        <option value="DIPLOMA" selected="selected" >CURRENT</option>
