  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Employee Address Form</li>
      </ol>
    </section><br>
        ...
        <div class="col-md-12" >
          <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Employee Address Form</h3>
              </div>
            <div class="box box-body">
              <div class="col-md-12">
                ...
                <form action="http://localhost/phintraco/c_employee/new_bankaccountform" method="POST"> <!-- << showData ini contoh, nggak usah dipake gpp -->
                  <br>
