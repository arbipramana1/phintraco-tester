  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Employee Claim Medical</li>
      </ol>
    </section><br>
        ...
        <div class="col-md-12" >
          <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Employee Claim Medical</h3>
              </div>
                ...
                <template id="row-item">
                  <tr class="row-item">
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-left datepicker" name="" required required style="width:150px;"><!--to date-->
                      </div>
                    </td>
                    <td>
                 ...
                 <tr><td><br><br><b>Record Claim Medical</b></td></tr>
