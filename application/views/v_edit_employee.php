            ...
            <div class="col-md-12">
             ...
             <td>
              <select name="" class="form-control select2" style="width: 20%;" required>
                  <option name="" id="0" value="Employee_Status" selected="selected" style="width:500px;">Employee Status Approval</option>
              </select>
             </td></tr>  
             ...
             <tr><td width="15%"><label>Confirm Date </label></td>
             <td>
              <div class="input-group date">
                <div class="input-group-addon">
                  <i class="fa fa-calendar"></i>
             ...
             <tr><td width="15%"><label>Resign Date </label></td>
             <td>
              <div class="input-group date">
                <div class="input-group-addon">
                  <i class="fa fa-calendar"></i>
             ...
             <tr><td width="15%"><label>Resign Note  : </label></td><td> <textarea class="form-control" rows="3" placeholder="Resign Note..." style="width:500px;"></textarea> 
             </td></tr>
             ...
             <tr><td width="15%"><label>Goongan/ Pangkat : </label></td>
             <td>
             <select name="" class="form-control select2" style="width: 20%" required>
                  <option name="" id="0" value="Employee_Status" selected="selected" >Golongan/ Pangkat</option>
             </select>
             </td></tr>

            <tr><td><b>RECORD</b><td></td>
