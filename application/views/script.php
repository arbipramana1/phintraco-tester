...
<!-- Select2 -->
<script src="<?= base_url('assets/admin-lte/plugins/select2/select2.full.min.js') ?>"></script>
<!-- InputMask -->
...
<script src="<?= base_url('assets/admin-lte/plugins/datepicker/bootstrap-datepicker.js') ?>"></script>
<!-- bootstrap color picker -->
<script src="<?= base_url('assets/admin-lte/plugins/colorpicker/bootstrap-colorpicker.min.js') ?>"></script>
...
<script src="<?= base_url('assets/admin-lte/plugins/datatables/dataTables.bootstrap.min.js')?>"></script>
<!-- Page script -->
<script>
  $(function () {
