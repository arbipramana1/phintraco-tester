  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Alamat Data Karyawan</li>
      </ol>
    </section>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <form role="form" action="<?php echo base_url(). 'C_data_karyawan/update_address/'.$nrp; ?>" method="post">
            <!-- general form elements -->
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Tambah Alamat Data Karyawan</h3>
              </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <label>Address*</label>
                        <textarea class="form-control" name="address" value="" required><?php echo $u->address ?></textarea>
                        <label>City*</label>
                        <input class="form-control" type="text" name="city" value="<?php echo $u->city ?>" required>
